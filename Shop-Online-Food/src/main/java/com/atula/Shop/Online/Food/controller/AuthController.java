...
import com.atula.Shop.Online.Food.request.LoginRequest;
import com.atula.Shop.Online.Food.response.AuthResponse;
import com.atula.Shop.Online.Food.service.CustomerUserDetailService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> createUserHandler(@RequestBody User user) throws Exception {
        ...
        if(isUserExist!=null) {
            throw new Exception("Email is created. Please create new email!");
        }
    ...
    public ResponseEntity<AuthResponse> signin(@RequestBody LoginRequest req){
        ...
        try{
            ...
            authResponse.setMessage("Login False");
